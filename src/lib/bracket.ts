...
const R16: KoMatch[] = [
  ...
  // Kickoff delayed an hour (6pm → 7pm local) by a thunderstorm in Mexico City.
  { id: "m92", num: 92, home: P("m79"), away: P("m80"), date: "2026-07-05", kickoff: "2026-07-06T01:00:00Z", venue: "Estadio Azteca · Mexico City" },
