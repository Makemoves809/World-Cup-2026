...
const BRAZIL: TeamSquad = {
  ...
  players: [
    ...
    { num: 6, name: "Alex Sandro", short: "A. Sandro", line: "def", role: "Left-back", club: "Flamengo", at2022: true, photo: "FC Zenit Saint Petersburg vs. Juventus, 20 October 2021 28 - Alex Sandro (cropped).jpg", start: { x: 16, y: 70 } },
...
const JAPAN: TeamSquad = {
  teamId: "jpn",
  // 4-2-3-1 — XI vs Tunisia (4–0). Some bench numbers best-effort.
  formation: "4-2-3-1",
  players: [
    { num: 1, name: "Zion Suzuki", short: "Z. Suzuki", line: "gk", role: "Goalkeeper", club: "Parma", at2022: false, start: { x: 50, y: 90 } },
    { num: 3, name: "Hiroki Itō", short: "H. Itō", line: "def", role: "Right-back", club: "Bayern Munich", at2022: false, start: { x: 84, y: 70 } },
    { num: 22, name: "Ko Itakura", short: "Itakura", line: "def", role: "Centre-back", club: "Borussia M'gladbach", at2022: true, start: { x: 62, y: 73 } },
    { num: 16, name: "Takehiro Tomiyasu", short: "Tomiyasu", line: "def", role: "Centre-back", club: "Arsenal", at2022: true, captain: true, start: { x: 38, y: 73 } },
    { num: 5, name: "Yukinari Sugawara", short: "Sugawara", line: "def", role: "Left-back", club: "Southampton", at2022: false, start: { x: 16, y: 70 } },
    { num: 17, name: "Kaishu Sano", short: "Sano", line: "mid", role: "Defensive midfield", club: "Mainz", at2022: false, start: { x: 64, y: 50 } },
    { num: 13, name: "Ao Tanaka", short: "Tanaka", line: "mid", role: "Central midfield", club: "Leeds United", at2022: true, start: { x: 36, y: 50 } },
    { num: 14, name: "Junya Itō", short: "J. Itō", line: "fwd", role: "Right winger", club: "Reims", at2022: true, start: { x: 78, y: 29 } },
    { num: 15, name: "Daichi Kamada", short: "Kamada", line: "mid", role: "Attacking midfield", club: "Crystal Palace", at2022: true, start: { x: 50, y: 31 } },
    { num: 8, name: "Ritsu Doan", short: "Doan", line: "fwd", role: "Left winger", club: "Eintracht Frankfurt", at2022: true, start: { x: 22, y: 29 } },
    { num: 19, name: "Ayase Ueda", short: "Ueda", line: "fwd", role: "Striker", club: "Feyenoord", at2022: false, start: { x: 50, y: 13 } },
    ...
    { num: 4, name: "Shogo Taniguchi", short: "Taniguchi", line: "def", role: "Centre-back", club: "Sint-Truiden", at2022: true },
...
const TUNISIA: TeamSquad = {
  ...
  players: [
    ...
    { num: 6, name: "Dylan Bronn", short: "Bronn", line: "def", role: "Centre-back", club: "Salernitana", at2022: true, start: { x: 38, y: 73 } },
    { num: 12, name: "Ali Abdi", short: "Abdi", line: "def", role: "Left-back", club: "Nice", at2022: false, start: { x: 16, y: 70 } },
    { num: 5, name: "Ellyes Skhiri", short: "Skhiri", line: "mid", role: "Defensive midfield", club: "Eintracht Frankfurt", at2022: true, start: { x: 64, y: 50 } },
    { num: 8, name: "Aïssa Laïdouni", short: "Laïdouni", line: "mid", role: "Defensive midfield", club: "Union Berlin", at2022: true, start: { x: 36, y: 50 } },
    { num: 7, name: "Elias Achouri", short: "Achouri", line: "fwd", role: "Right winger", club: "Copenhagen", at2022: false, start: { x: 78, y: 29 } },
    { num: 10, name: "Hannibal Mejbri", short: "Hannibal", line: "mid", role: "Attacking midfield", club: "Burnley", at2022: true, start: { x: 50, y: 31 } },
    { num: 11, name: "Ismaël Gharbi", short: "Gharbi", line: "fwd", role: "Left winger", club: "Saint-Étienne", at2022: false, start: { x: 22, y: 29 } },
...
const ECUADOR: TeamSquad = {
  ...
  formation: "4-3-3",
  players: [
    { num: 1, name: "Hernán Galíndez", short: "Galíndez", line: "gk", role: "Goalkeeper", club: "Huracán", at2022: true, start: { x: 50, y: 90 } },
    { num: 4, name: "Alan Franco", short: "Franco", line: "def", role: "Right-back", club: "Atlético Mineiro", at2022: false, start: { x: 84, y: 70 } },
    { num: 3, name: "Piero Hincapié", short: "Hincapié", line: "def", role: "Centre-back", club: "Bayer Leverkusen", at2022: true, start: { x: 62, y: 73 } },
    { num: 2, name: "Willian Pacho", short: "Pacho", line: "def", role: "Centre-back", club: "Paris Saint-Germain", at2022: false, start: { x: 38, y: 73 } },
    { num: 7, name: "Pervis Estupiñán", short: "Estupiñán", line: "def", role: "Left-back", club: "AC Milan", at2022: true, start: { x: 16, y: 70 } },
    { num: 23, name: "Moisés Caicedo", short: "M. Caicedo", line: "mid", role: "Defensive midfield", club: "Chelsea", at2022: true, captain: true, start: { x: 50, y: 48 } },
    ...
    { num: 13, name: "Enner Valencia", short: "Valencia", line: "fwd", role: "Striker", club: "Inter Miami", at2022: true, start: { x: 50, y: 13 } },
    { num: 11, name: "John Yeboah", short: "Yeboah", line: "fwd", role: "Left winger", club: "Vancouver Whitecaps", at2022: false, start: { x: 18, y: 18 } },
...
const CURACAO: TeamSquad = {
  ...
  formation: "4-2-3-1",
  players: [
    { num: 1, name: "Eloy Room", short: "Room", line: "gk", role: "Goalkeeper", club: "Columbus Crew", at2022: false, start: { x: 50, y: 90 } },
    ...
    { num: 4, name: "Sherel Floranus", short: "Floranus", line: "def", role: "Centre-back", club: "Heerenveen", at2022: false, start: { x: 38, y: 73 } },
    { num: 3, name: "Deveron Fonville", short: "Fonville", line: "def", role: "Left-back", club: "MVV Maastricht", at2022: false, start: { x: 16, y: 70 } },
    { num: 6, name: "Leandro Bacuna", short: "L. Bacuna", line: "mid", role: "Defensive midfield", club: "Vitesse", at2022: false, captain: true, start: { x: 64, y: 50 } },
    { num: 10, name: "Juninho Bacuna", short: "J. Bacuna", line: "mid", role: "Central midfield", club: "Birmingham", at2022: false, start: { x: 36, y: 50 } },
    { num: 7, name: "Tahith Chong", short: "Chong", line: "fwd", role: "Right winger", club: "Sheffield United", at2022: false, start: { x: 78, y: 29 } },
    ...
    { num: 11, name: "Sontje Hansen", short: "Hansen", line: "fwd", role: "Left winger", club: "NEC", at2022: false, start: { x: 22, y: 29 } },
    { num: 9, name: "Jürgen Locadia", short: "Locadia", line: "fwd", role: "Striker", club: "PEC Zwolle", at2022: false, start: { x: 50, y: 13 } },
...
const BOSNIA: TeamSquad = {
  ...
  players: [
    ...
    { num: 14, name: "Benjamin Tahirović", short: "Tahirović", line: "mid", role: "Central midfield", club: "Ajax", at2022: false, photo: "Benjamin Tahirović - GAE - Ajax (53465349575).jpg", start: { x: 38, y: 50 } },
