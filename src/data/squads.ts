...
const BRAZIL: TeamSquad = {
  ...
  players: [
    ...
    { num: 7, name: "Vinícius Júnior", short: "Vini Jr", line: "fwd", role: "Left winger", club: "Real Madrid", at2022: true, start: { x: 18, y: 18 } },
...
const GERMANY: TeamSquad = {
  ...
  players: [
    ...
    { num: 10, name: "Jamal Musiala", short: "Musiala", line: "mid", role: "Attacking midfield", club: "Bayern Munich", at2022: true, start: { x: 50, y: 31 } },
    { num: 17, name: "Florian Wirtz", short: "Wirtz", line: "fwd", role: "Left winger", club: "Liverpool", at2022: false, start: { x: 22, y: 29 } },
...
const TURKIYE: TeamSquad = {
  teamId: "tur",
  // Most recent: vs Paraguay (0–1) — a 4-2-3-1. Some shirt numbers best-effort.
  formation: "4-2-3-1",
  players: [
    { num: 1, name: "Uğurcan Çakır", short: "Çakır", line: "gk", role: "Goalkeeper", club: "Galatasaray", at2022: false, start: { x: 50, y: 90 } },
    ...
    { num: 4, name: "Abdülkerim Bardakcı", short: "Bardakcı", line: "def", role: "Centre-back", club: "Galatasaray", at2022: false, start: { x: 38, y: 73 } },
    { num: 14, name: "Ferdi Kadıoğlu", short: "Kadıoğlu", line: "def", role: "Left-back", club: "Brighton", at2022: false, start: { x: 16, y: 70 } },
    { num: 6, name: "İsmail Yüksek", short: "Yüksek", line: "mid", role: "Defensive midfield", club: "Fenerbahçe", at2022: false, start: { x: 64, y: 50 } },
    { num: 10, name: "Hakan Çalhanoğlu", short: "Çalhanoğlu", line: "mid", role: "Central midfield", club: "Inter Milan", at2022: false, captain: true, start: { x: 36, y: 50 } },
    { num: 8, name: "Arda Güler", short: "Güler", line: "mid", role: "Right winger", club: "Real Madrid", at2022: false, start: { x: 78, y: 29 } },
    { num: 18, name: "Orkun Kökçü", short: "Kökçü", line: "mid", role: "Attacking midfield", club: "Beşiktaş", at2022: false, start: { x: 50, y: 31 } },
    { num: 19, name: "Kenan Yıldız", short: "Yıldız", line: "fwd", role: "Left winger", club: "Juventus", at2022: false, start: { x: 22, y: 29 } },
    { num: 9, name: "Deniz Gül", short: "Gül", line: "fwd", role: "Striker", club: "Porto", at2022: false, start: { x: 50, y: 13 } },

    { num: 12, name: "Mert Günok", short: "Günok", line: "gk", role: "Goalkeeper", club: "Beşiktaş", at2022: false },
    { num: 23, name: "Altay Bayındır", short: "Bayındır", line: "gk", role: "Goalkeeper", club: "Manchester United", at2022: false },
    { num: 5, name: "Kaan Ayhan", short: "Ayhan", line: "def", role: "Centre-back", club: "Galatasaray", at2022: false },
    { num: 13, name: "Samet Akaydın", short: "Akaydın", line: "def", role: "Centre-back", club: "Panathinaikos", at2022: false },
    { num: 15, name: "Mert Müldür", short: "Müldür", line: "def", role: "Right-back", club: "Fenerbahçe", at2022: false },
    { num: 21, name: "Eren Elmalı", short: "Elmalı", line: "def", role: "Left-back", club: "Galatasaray", at2022: false },
    { num: 16, name: "Salih Özcan", short: "Özcan", line: "mid", role: "Defensive midfield", club: "Borussia Dortmund", at2022: false },
    { num: 20, name: "Yunus Akgün", short: "Akgün", line: "mid", role: "Winger", club: "Galatasaray", at2022: false },
    { num: 7, name: "Kerem Aktürkoğlu", short: "Aktürkoğlu", line: "fwd", role: "Winger", club: "Fenerbahçe", at2022: false },
    { num: 11, name: "Barış Alper Yılmaz", short: "Barış", line: "fwd", role: "Winger", club: "Galatasaray", at2022: false },
    { num: 17, name: "İrfan Can Kahveci", short: "Kahveci", line: "mid", role: "Attacking midfield", club: "Fenerbahçe", at2022: false },
