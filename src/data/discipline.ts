...
const curated: PlayerAbsence[] = [
  ...
  },
  {
    ...
    team: "fra",
    type: "injury",
    reason: "Ruptured Achilles tendon — injured April 14, 2026 for Liverpool (UCL QF 2nd leg vs PSG), months before the World Cup",
    missesMatchIds: teamMatchIds("fra"),
    outForTournament: true,
    impact: 3,
    note: "Hurt at club level (Liverpool) in the Champions League, well before the tournament — never played a France World Cup match this summer.",
  },
  {
  ...
  },
  {
    ...
    team: "mar",
    type: "injury",
    reason: "Groin injury (pubalgia) — hadn't played since Mar. 4, 2026 (Marseille); cut from the World Cup squad June 10, three days before the opener",
    missesMatchIds: teamMatchIds("mar"),
    outForTournament: true,
    impact: 4,
    note: "Cut from Morocco's squad before a ball was kicked at the tournament — replaced by Marwane Saadane, never played a World Cup match.",
  },
  {
    ...
    team: "mar",
    type: "injury",
    reason: "Knee (MCL) sprain — hurt in a June 7, 2026 pre-tournament warm-up friendly vs Norway (collision w/ Chadi Riad); cut from the squad June 10",
    missesMatchIds: teamMatchIds("mar"),
    outForTournament: true,
    impact: 4,
    note: "Cut from Morocco's squad before the tournament started (replaced by Amine Sbaï) — never played a World Cup match; injury came in a warm-up friendly, not a WC fixture.",
  },
  {
